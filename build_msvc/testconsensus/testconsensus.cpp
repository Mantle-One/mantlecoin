...
// mantle includes.
#include <..\src\script\mantleconsensus.h>
...
int main()
{
    std::cout << "mantleconsensus version: " << mantleconsensus_version() << std::endl;
    ...
    auto op0Result = mantleconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, mantleconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
