...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Mantle
else
  DOCKER_EXEC echo \> \$HOME/.mantle
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/mantle/mantle/pull/18288#discussion_r433189350 for
  # details.
