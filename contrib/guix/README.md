# Bootstrappable Mantle Core Builds

This directory contains the files necessary to perform bootstrappable Mantle
Core builds.
...
- 24GB of free disk space on the partition that the Mantle Core git repository
  resides in
...
For a Mantle Core depends development environment, simply invoke
...
From the top of a clean Mantle Core repository:
...
To use dongcarl's substitute server for Mantle Core builds after having
