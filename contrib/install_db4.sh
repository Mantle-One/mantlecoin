...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the mantle repository."
  exit 1
fi
...
# See https://github.com/mantle/mantle/issues/16064
...
echo 'When compiling mantled, run `./configure` in the following way:'
echo
