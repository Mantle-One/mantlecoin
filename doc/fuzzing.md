# Fuzzing Mantle Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing Mantle Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):

```sh
$ git clone https://github.com/mantle/mantle
$ cd mantle/
$ ./autogen.sh
$ CC=clang CXX=clang++ ./configure --enable-fuzz --with-sanitizers=address,fuzzer,undefined
# macOS users: If you have problem with this step then make sure to read "macOS hints for
# libFuzzer" on https://github.com/mantle/mantle/blob/master/doc/fuzzing.md#macos-hints-for-libfuzzer
$ make
...
[`process_message`](https://github.com/mantle/mantle/blob/master/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/mantle/mantle/blob/master/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/mantle/mantle/tree/master/src/test/fuzz).
...
The project's collection of seed corpora is found in the [`mantle-core/qa-assets`](https://github.com/mantle-core/qa-assets) repo.

To fuzz `process_message` using the [`mantle-core/qa-assets`](https://github.com/mantle-core/qa-assets) seed corpus:

```sh
$ git clone https://github.com/mantle-core/qa-assets
...
If you find coverage increasing inputs when fuzzing you are highly encouraged to submit them for inclusion in the [`mantle-core/qa-assets`](https://github.com/mantle-core/qa-assets) repo.

Every single pull request submitted against the Mantle Core repo is automatically tested against all inputs in the [`mantle-core/qa-assets`](https://github.com/mantle-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Mantle Core more robust.
...
with certain assembly code from Mantle Core's code. See [developer notes on sanitizers](https://github.com/mantle/mantle/blob/master/doc/developer-notes.md#sanitizers)
...
# Fuzzing Mantle Core using american fuzzy lop (`afl-fuzz`)

## Quickstart guide

To quickly get started fuzzing Mantle Core using [`afl-fuzz`](https://github.com/google/afl):
...
# Fuzzing Mantle Core using Honggfuzz

## Quickstart guide

To quickly get started fuzzing Mantle Core using [Honggfuzz](https://github.com/google/honggfuzz):
