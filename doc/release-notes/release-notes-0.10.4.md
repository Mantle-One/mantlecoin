Mantle Core version 0.10.4 is now available from:

  <https://mantle.org/bin/mantle-core-0.10.4/>
...
- #6953 `43c2789` Split mantle-tx into its own package
- #6953 `dfe0d4d` Include mantle-tx binary on Debian/Ubuntu
