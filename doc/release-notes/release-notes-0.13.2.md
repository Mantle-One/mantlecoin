Mantle Core version 0.13.2 is now available from:

  <https://mantle.org/bin/mantle-core-0.13.2/>
...
- #8908 `4a974b2` Update mantle-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow mantle-tx to create v2 transactions (macdrak)
