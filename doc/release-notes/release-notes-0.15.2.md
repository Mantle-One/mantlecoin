Mantle Core version *0.15.2* is now available from:

  <https://mantlecore.org/bin/mantle-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in mantle-tx (TheBlueMatt)
