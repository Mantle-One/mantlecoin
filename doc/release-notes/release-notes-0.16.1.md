Mantle Core version 0.16.1 is now available from:

  <https://mantlecore.org/bin/mantle-core-0.16.1/>
...
- #12843 `df38b13` Test starting mantled with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure mantled processes are cleaned up when tests end (sdaftuar)
