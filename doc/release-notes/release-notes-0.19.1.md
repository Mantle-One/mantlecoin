...
Mantle Core version 0.19.1 is now available from:

  <https://mantlecore.org/bin/mantle-core-0.19.1/>
...
From Mantle Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Mantle Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Mantle Core does not yet change appearance when
...
- #17488 fix "mantled already running" warnings on macOS (fanquake)
