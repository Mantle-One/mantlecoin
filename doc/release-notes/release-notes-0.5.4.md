Mantle version 0.5.4 is now available for download at:
http://sourceforge.net/projects/mantle/files/Mantle/mantle-0.5.4/
...
http://gitorious.org/mantle/mantled-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Mantle-Qt notifications under Growl 1.3.
Increase required age of Mantle-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxMantle properly when installing Mantle-Qt over it. (Windows)
