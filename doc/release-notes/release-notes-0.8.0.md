Mantle-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/mantle/files/Mantle/mantle-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Mantle
...
New/changed settings (command-line or mantle.conf file)
--------------------------------------------------------
