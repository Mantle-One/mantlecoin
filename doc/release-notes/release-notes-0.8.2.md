Mantle-Qt version 0.8.2 is now available from:
  http://sourceforge.net/projects/mantle/files/Mantle/mantle-0.8.2/
...
MacOSX:
* OSX support for click-to-pay (mantle:) links
...
* Entering the 'getblocktemplate' or 'getwork' RPC commands into the Mantle-Qt debug
console will cause Mantle-Qt to crash. Run Mantle-Qt with the -server command-line
