Mantle Core version 0.9.4 is now available from:

  https://mantle.org/bin/0.9.4/
...
this update is incompatible with the Mantle system and could lead to consensus
forks.

Mantle Core released binaries from https://mantle.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~mantle/+archive/ubuntu/mantle
- A third-party or self-compiled Mantle Core

upgrade to Mantle Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
