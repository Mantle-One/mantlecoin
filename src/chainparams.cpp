...
{
    const char* pszTimestamp = "BBC News 23/Dec/2021 Energy bills to soar 50% unless government intervenes, industry warns";
...
public:
    CMainParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nTimeout = 1640258100;
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].min_activation_height = 0; // No activation delay

        // Deployment of Taproot (BIPs 340-342)
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].bit = 2;
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nStartTime = 0; // April 24th, 2021
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nTimeout = 1640258100; // August 11th, 2021
	...
	pchMessageStart[3] = 0xdb;
        ...
        genesis = CreateGenesisBlock(1640258100, 133193, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000a2d1d8b66f408eb856e6a1151afcd55313b940356f43e7af9fd4cbdc562"));
        assert(genesis.hashMerkleRoot == uint256S("0xd2e8575501c70843c422bd5d2f178ed9660df4619ce9799c3f60897196ecf4e4"));
...
public:
    CTestNetParams() {
        ...
        consensus.BIP34Hash = uint256S("00000a2d1d8b66f408eb856e6a1151afcd55313b940356f43e7af9fd4cbdc562");
