...
#ifndef MANTLE_COMPAT_ASSUMPTIONS_H
#define MANTLE_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Mantle cannot be compiled without assertions."
#endif
...
#endif // MANTLE_COMPAT_ASSUMPTIONS_H
