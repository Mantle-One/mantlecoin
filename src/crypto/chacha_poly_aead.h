...
#ifndef MANTLE_CRYPTO_CHACHA_POLY_AEAD_H
#define MANTLE_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@mantle.
 *
 ...
 *
 * The chacha20-poly1305@mantle combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@mantle cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@mantle are relatively fast in
...
#endif // MANTLE_CRYPTO_CHACHA_POLY_AEAD_H
