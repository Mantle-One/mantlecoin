...
static void SetupMantleTxArgs(ArgsManager &argsman)
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " mantle-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  mantle-tx [options] <hex-tx> [commands]  Update hex-encoded mantle transaction\n" +
            "or:     mantle-tx [options] -create [commands]   Create hex-encoded mantle transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mantle transaction
