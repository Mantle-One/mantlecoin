...
#ifndef MANTLE_QT_GUIUTIL_H
#define MANTLE_QT_GUIUTIL_H
...
/** Utility functions used by the Mantle Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "mantle:" URI into recipient object, return true on successful parsing
