    ...
    mapper(nullptr)
{
    ...
    ui->mantleAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->mantleAtStartup);
    ...
    ui->mantleAtStartup->setToolTip(ui->mantleAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->mantleAtStartup->setText(ui->mantleAtStartup->text().arg(PACKAGE_NAME));

    ui->openMantleConfButton->setToolTip(ui->openMantleConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new MantleUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->mantleAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openMantleConfButton_clicked()
{
