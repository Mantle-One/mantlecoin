    ...
    platformStyle(_platformStyle)
{
    ...
    // normal mantle address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying mantle address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &MantleAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
