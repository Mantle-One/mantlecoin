...
//! Entry point for MantleApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &MantleApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for MantleGUI tests.
void AppTests::guiTests(MantleGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &MantleGUI::consoleShown, this, &AppTests::consoleTests);
