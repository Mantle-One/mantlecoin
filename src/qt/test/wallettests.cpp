// Copyright (c) 2015-2020 The Mantle Core developers
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<MantleAmountField*>("payAmount")->setValue(amount);
...
//
//     QT_QPA_PLATFORM=xcb     src/qt/test/test_mantle-qt  # Linux
//     QT_QPA_PLATFORM=windows src/qt/test/test_mantle-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   src/qt/test/test_mantle-qt  # macOS
void TestGUI(interfaces::Node& node)
{
...

    {
        ...
        QString balanceComparison = MantleUnits::formatWithUnit(unit, balance, false, MantleUnits::SeparatorStyle::ALWAYS);
    ...
    // Amount input
    MantleAmountField* amountInput = receiveCoinsDialog.findChild<MantleAmountField*>("reqAmount");
...
void WalletTests::walletTests()
{
    ...
    if (QApplication::platformName() == "minimal") {
        ...
        QWARN("Skipping WalletTests on mac build with 'minimal' platform set due to Qt bugs. To run AppTests, invoke "
              "with 'QT_QPA_PLATFORM=cocoa test_mantle-qt' on mac, or else use a linux or windows build.");
        return;
    }
#endif
    TestGUI(m_node);
