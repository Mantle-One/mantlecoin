...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, MantleGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &MantleGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &MantleGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &MantleGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &MantleGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &MantleGUI::updateWalletStatus);
    connect(gui, &MantleGUI::setPrivacy, walletView, &WalletView::setPrivacy);
