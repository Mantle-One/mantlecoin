...
#ifndef MANTLE_TEST_SCRIPTNUM10_H
#define MANTLE_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Mantle Core 0.10.0, for cross-comparison.
 */
public:
