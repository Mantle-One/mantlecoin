 ...
 */
#ifndef MANTLE_UTIL_SYSTEM_H
#define MANTLE_UTIL_SYSTEM_H
...
extern const char * const MANTLE_CONF_FILENAME;
extern const char * const MANTLE_SETTINGS_FILENAME;
