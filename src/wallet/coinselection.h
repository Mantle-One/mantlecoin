// Copyright (c) 2017-2018 The Mantle Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef MANTLE_WALLET_COINSELECTION_H
#define MANTLE_WALLET_COINSELECTION_H
...
#endif // MANTLE_WALLET_COINSELECTION_H
