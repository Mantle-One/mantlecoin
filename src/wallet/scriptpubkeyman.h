...
#ifndef MANTLE_WALLET_SCRIPTPUBKEYMAN_H
#define MANTLE_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Mantle Core wallet was originally a collection of unrelated private
...
#endif // MANTLE_WALLET_SCRIPTPUBKEYMAN_H
