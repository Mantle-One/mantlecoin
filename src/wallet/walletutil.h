...
#ifndef MANTLE_WALLET_WALLETUTIL_H
#define MANTLE_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! mantle from opening the wallet, thinking it was newly created, and
...
#endif // MANTLE_WALLET_WALLETUTIL_H
