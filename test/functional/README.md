...
- The oldest supported Python version is specified in [doc/dependencies.md](/doc/dependencies.md).
  ...
  The Travis linter also checks this, but [possibly not in all cases](https://github.com/mantle/mantle/pull/14884#discussion_r239585126).
...
- Use a module-level docstring to describe what the test is testing, and how it
  is testing it.
- When subclassing the MantleTestFramework, place overrides for the
...
with the mantled(s) being tested in a callback-based event loop; the other
implements the test logic.

- `P2PConnection` is the class used to connect to a mantled.  `P2PInterface`
contains the higher level logic for processing P2P payloads and connecting to
the Mantle Core node application logic. For custom behaviour, subclass the
...
The [`TestShell`](test-shell.md) class exposes the MantleTestFramework
...
Taken from the [python-mantlerpc repository](https://github.com/jgarzik/python-mantlerpc).
...
Test objects for interacting with a mantled node over the p2p interface.

#### [script.py](test_framework/script.py)
Utilities for manipulating transaction scripts (originally from python-mantlelib)
