...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the MantleTestFramework
    pass


class ExampleTest(MantleTestFramework):
    # Each functional test is a subclass of the MantleTestFramework class.
    ...
    def custom_method(self):
        ...
        MantleTestFramework class so other tests can use it."""
