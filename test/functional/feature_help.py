...
"""Verify that starting mantle with -h works as expected."""

from test_framework.test_framework import MantleTestFramework
from test_framework.util import assert_equal

class HelpTest(MantleTestFramework):
    ...
    def run_test(self):
        self.log.info("Start mantle with -h for help text")
        ...
        self.log.info("Start mantle with -version for version information")
        ...
        self.log.info("Start mantled with -fakearg to make sure it does not start")
