...
By default, mantled will dump mempool on shutdown and
...
class MempoolPersistTest(MantleTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent mantled from writing mempool.dat to disk. Verify that `savemempool` fails")
