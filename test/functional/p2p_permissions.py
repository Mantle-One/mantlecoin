...
class P2PPermissionsTests(MantleTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].mantleconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].mantleconf, 'w', encoding="utf8") as f:
            f.write(newText)
