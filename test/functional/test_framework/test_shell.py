...
class TestShell:
    """Wrapper Class for MantleTestFramework.

    The TestShell class extends the MantleTestFramework
    ...
    class __TestShell(MantleTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by MantleTestFramework child class.
            self.num_nodes = 1
